...
public static partial class Pulse
{
    ...
    /// </summary>
    public static Flow<Flow> ToFlowIf<T, TBox>(Func<TBox, bool> predicate, Flow<T> flow, Func<T> value) =>
    ...
    /// </summary>
    public static Flow<Flow> ToFlowIf<T, TBox>(Func<TBox, bool> predicate, Flow<T> flow, Func<IEnumerable<T>> values) =>
    ...
    /// </summary>
    public static Flow<Flow> ToFlowIf<T, TBox>(Func<TBox, bool> predicate, Func<T, Flow<Flow>> flowFactory, Func<T> value) =>
        Runnel(Sluice(predicate), Single(value), IntoFactory(flowFactory));
    ...
    /// </summary>
    public static Flow<Flow> ToFlowIf<T, TBox>(Func<TBox, bool> predicate, Func<T, Flow<Flow>> flowFactory, Func<IEnumerable<T>> values) =>
        Runnel(Sluice(predicate), Many(values), IntoFactory(flowFactory));
}
