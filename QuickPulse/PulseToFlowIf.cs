...
public static partial class Pulse
{
    ...
    /// </summary>
    public static Flow<Unit> ToFlowIf<T, TBox>(Func<TBox, bool> predicate, Func<T, Flow<Unit>> flowFactory, Func<T> value) =>
    ...
    /// </summary>
    public static Flow<Unit> ToFlowIf<T, TBox>(Func<TBox, bool> predicate, Func<T, Flow<Unit>> flowFactory, Func<IEnumerable<T>> values) =>
