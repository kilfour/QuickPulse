...
public static partial class Pulse
{
    ...
    /// Use for simple conditional execution inside a flow.
    /// </summary>
    public static Flow<Flow> When(this Flow<Flow> other, bool flag, Flow<Flow> flow) =>
        other.Then(When(flag, flow));
    ...
    /// Use for state-aware conditional branching.
    /// </summary>
    public static Flow<Flow> When<TCell>(this Flow<Flow> other, Func<TCell, bool> predicate, Flow<Flow> flow) =>
        other.Then(When(predicate, flow));
    ...
    /// Use to defer flow creation until needed.
    /// </summary>
    public static Flow<Flow> When(this Flow<Flow> other, bool flag, Func<Flow<Flow>> flowFactory) =>
        other.Then(When(flag, flowFactory));
    ...
    /// Use for lazy, context-sensitive branching.
    /// </summary>
    public static Flow<Flow> When<TCell>(this Flow<Flow> other, Func<TCell, bool> predicate, Func<Flow<Flow>> flowFactory) =>
        other.Then(When(predicate, flowFactory));
}
