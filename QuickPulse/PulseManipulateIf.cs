...
public static partial class Pulse
{
    ...
    /// Updates the stored value when the flag is true. Use for simple conditional state changes.
    /// </summary>
    public static Flow<TCell> ManipulateIf<TCell>(this Flow<Flow> other, bool flag, Func<TCell, TCell> manipulate) =>
        other.Then(ManipulateIf(flag, manipulate));
    ...
    /// Updates the stored value when the predicate evaluates to true for the current state. Use for context-sensitive mutations.
    /// </summary>
    public static Flow<TCell> ManipulateIf<TCell>(this Flow<Flow> other, Func<TCell, bool> predicate, Func<TCell, TCell> manipulate) =>
        other.Then(ManipulateIf(predicate, manipulate));
}
