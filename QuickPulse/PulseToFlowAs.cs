...
public static partial class Pulse
{
    ...
    /// </summary>
    public static Flow<Unit> ToFlowAs<T>(Flow<T> flow, object value) where T : class =>
    ...
    /// </summary>
    public static Flow<Unit> ToFlowAs<T>(Func<T, Flow<Unit>> flowFactory, object value) where T : class =>
    ...
    /// </summary>
    public static Flow<Unit> ToFlowAs<T>(Flow<T> flow, IEnumerable<object> values) where T : class =>
    ...
    /// </summary>
    public static Flow<Unit> ToFlowAs<T>(Func<T, Flow<Unit>> flowFactory, IEnumerable<object> values) where T : class =>
