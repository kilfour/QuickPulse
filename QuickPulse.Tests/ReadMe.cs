...
Or, ... see [A Quick Pulse](https://github.com/kilfour/QuickPulse/blob/main/Docs/A_AQuickPulse/AQuickPulse.md) for a hands-on quickstart.")]
    ...
    [DocHeader("Real-World Usage")]
    [DocContent(@"
QuickPulse powers our documentation system.
The [QuickPulse.Explains](https://github.com/kilfour/QuickPulse.Explains) library
(which generates this documentation) uses QuickPulse to process reference materials into markdown.
```csharp
...
**So the documentation you're reading right now was generated by QuickPulse flows.**")]
